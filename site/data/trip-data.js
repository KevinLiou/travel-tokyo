...
export const tripData = {
  ...
  days: [
    ...
    },
    {
      ...
      timeline: [
        ...
        node("dinner-d2", "20:00–21:00", "20:00", "21:00", "WAGYU SUKIYAKI GOKU Shinjuku", "新宿 3-35-17", "由 Busta 新宿步行約 5～10 分鐘", "20:00 已預約；尖峰時段可能限時 45 分鐘。", "已預約", "WAGYU SUKIYAKI GOKU Shinjuku"),
    ...
    },
    {
      ...
      timeline: [
        ...
        node("inoue", "20:00–21:30", "20:00", "21:30", "晚餐：焼肉いのうえ 吉祥寺店", "吉祥寺", "店內用餐", "20:00 已預約。", "已預約", "焼肉いのうえ 吉祥寺店"),
    ...
    },
    {
      ...
      summary: "不吃早餐、10:00 退房寄放行李；早餐／早午餐二選一目前以 10:30 ねぎし為主，接著保留至少 3 小時採買 MOKUBA、貴和與 PARTS CLUB，21:15 回台。",
      ...
      timeline: [
        ...
        node("materials", "12:00–15:00", "12:00", "15:00", "淺草橋／蔵前素材採買＋秋葉原分流", "淺草橋／蔵前", "貴和製作所、PARTS CLUB、MOKUBA；男友可自由逛秋葉原", "12:00–13:00 先逛材料店，13:00 後排 MOKUBA。", "採買主力", "JR浅草橋駅"),
        ...
        node("meet", "15:00–15:30", "15:00", "15:30", "回飯店會合", "御徒町／Hotel Sardonyx Ueno", "淺草橋 → 秋葉原 → 御徒町；回飯店會合", "確認行李與機場要帶的最後物品。", "提醒", "Hotel Sardonyx Ueno"),
  ...
  checklist: [
    { id: "passport", group: "packing", dayId: null, label: "護照", description: "確認護照與必要影本／照片都已備妥。", done: false },
    ...
    { id: "personal-medicine", group: "medicine", dayId: null, label: "個人藥品", description: "依平常需求準備，處方藥保留原包裝並放在隨身行李。", done: false },
    { id: "d1-lunch", group: "restaurants", dayId: "d1", label: "月島もんじゃ もへじ 上野｜午餐", description: "Walk-in；出發前確認餐廳位置。", done: false },
    { id: "d1-dinner", group: "restaurants", dayId: "d1", label: "牛たん炭焼 利久 東京ソラマチ店｜晚餐", description: "Walk-in；以不影響 20:30 晴空塔為準。", done: false },
    { id: "d2-lunch", group: "restaurants", dayId: "d2", label: "ほうとう不動 河口湖駅前店｜午餐", description: "Walk-in；時間不足時改車站內輕食。", done: false },
    { id: "d2-dinner", group: "restaurants", dayId: "d2", label: "WAGYU SUKIYAKI GOKU｜20:00", description: "已預約；出發前確認訂位資訊與餐廳位置。", done: true },
    { id: "d3-lunch", group: "restaurants", dayId: "d3", label: "まめ蔵 吉祥寺｜午餐", description: "Walk-in；配合中道通動線。", done: false },
    { id: "d3-tea", group: "restaurants", dayId: "d3", label: "HARBS atre 吉祥寺店｜下午茶", description: "現場候位；依當天時間與體力調整。", done: false },
    { id: "d3-dinner", group: "restaurants", dayId: "d3", label: "焼肉いのうえ 吉祥寺店｜20:00", description: "已預約；出發前確認訂位資訊與餐廳位置。", done: true },
    { id: "d4-lunch", group: "restaurants", dayId: "d4", label: "極味や 東京站店｜午餐", description: "Walk-in；預留前往新幹線月台的緩衝。", done: false },
    { id: "d4-dinner", group: "restaurants", dayId: "d4", label: "伊豆中 ばんばん食堂 熱海｜晚餐", description: "Walk-in；約 18:00 到店。", done: false },
    { id: "d5-brunch", group: "restaurants", dayId: "d5", label: "ねぎし上野駅前店｜早午餐", description: "目前主選 10:30；不讓用餐壓縮淺草橋採買時間。", done: false },
    { id: "d5-airport-dinner", group: "restaurants", dayId: "d5", label: "一風堂 成田空港店｜機場晚餐", description: "優先選擇；依登機口與排隊狀況調整。", done: false },
    { id: "visit-japan-web", group: "before", dayId: null, label: "Visit Japan Web 申請", description: "出發前完成入境資料，確認 QR Code／登入資訊可正常開啟。", done: false },
    ...
    { id: "skyliner-roundtrip", group: "tickets", dayId: "d1", label: "京成 Skyliner 來回票", description: "D1 成田 T1 → 京成上野；D5 依回程時間確認班次與座位。", done: true },
    { id: "d1-skytree", group: "tickets", dayId: "d1", label: "東京晴空塔｜20:30", description: "天望甲板＋天望迴廊。", done: true },
    { id: "d2-bus-out", group: "tickets", dayId: "d2", label: "高速巴士去程｜07:15", description: "Busta 新宿 → 09:00 河口湖站。", done: true },
    { id: "d2-bus-back", group: "tickets", dayId: "d2", label: "高速巴士回程｜16:40", description: "忍野八海 → 18:55 Busta 新宿。", done: true },
    { id: "d4-shinkansen-out", group: "tickets", dayId: "d4", label: "SmartEX 去程｜14:57", description: "東京 → 熱海，指定席。", done: true },
    { id: "d4-shinkansen-back", group: "tickets", dayId: "d4", label: "SmartEX 回程｜22:02", description: "熱海 → 東京，指定席。", done: true },
  ...
  checklistGroups: [
    ...
    { id: "medicine", label: "藥品", title: "只列一項，依平常需求準備" },
    { id: "restaurants", label: "餐廳", title: "已確定的餐廳" },
